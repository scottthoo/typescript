...
/** @class */
function () {
  function CollectionView(parent, colleciton) {
    this.parent = parent;
  ...
  CollectionView.prototype.render = function () {
    ...
    for (var _i = 0, _a = this.colleciton.models; _i < _a.length; _i++) {
      var model = _a[_i];
...
function () {
  function Eventing() {
    ...
    this.events = {}; // events is an object that hv arrays of keys that return an arrays of callbacks

    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || []; // like this handlers Guaranteed will be an array
